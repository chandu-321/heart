...
########################################
app=Flask(__name__)
with open('model_pkl', 'rb') as pickle_file:
    model = pkl.load(pickle_file)
with open('encoder_cp', 'rb') as pickle_file:
    encoder_cp=pkl.load(pickle_file)
with open('encoder_exang', 'rb') as pickle_file:
    encoder_exang=pkl.load(pickle_file)
with open('encoder_sex', 'rb') as pickle_file:
    encoder_sex=pkl.load(pickle_file)
with open('encoder_slope', 'rb') as pickle_file:
